-- =============================================================================
-- ATUALIZAÇÃO — rodar em banco que já executou scripts/instalar.sql
--
-- Corrige um bug que impede criar usuários quando o domínio de e-mail é
-- compartilhado por várias unidades (o caso de @maristabrasil.org), e adiciona
-- a escolha de unidade no primeiro acesso.
--
